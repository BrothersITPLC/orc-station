...
def admin_top_regular_taxpayer_report(request):
    ...
    # Fetch top exporters by declaration count
    top_exporter_merchants = (
    ...
    for top_merchant_exporter in top_exporter_merchants:
        revenue, amount = calculate_merchant_revenue_and_amount(
            exporter=top_merchant_exporter, start_date=start_date, end_date=end_date
        )
        ...
        # Add merchant data to report
        report_data.append(
            {
                "tin_number": top_merchant_exporter.tin_number,
                "type": top_merchant_exporter.type.name,
                "exporter_name": f"{top_merchant_exporter.first_name} {top_merchant_exporter.last_name}",
                "total_amount": amount,
